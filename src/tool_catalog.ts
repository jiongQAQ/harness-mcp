...
export const TOOL_CATALOG: ToolCatalogEntry[] = [
  ...
  },
  {
    ...
    example: 'discover({ "source": "code", "goal": "客户创建订单", "capability": "order.create", "entrypoints": ["OrderController#create"], "call_chain": ["OrderService#create", "InventoryService#reserve"], "business_rules": ["有库存时创建待支付订单并锁定库存"], "examples": ["库存充足创建订单", "库存不足拒绝创建"], "evidence": [{ "source": "code", "detail": "OrderService#create" }] })',
  ...
  },
  {
    ...
    example: 'contract({ "kind": "capability", "id": "order.create", "file": "features/order/create.feature", "content": "...", "map_content": "..." })',
  ...
  },
  {
    ...
    example: 'verify({ "target_type": "capability", "target": "order.create" })',
